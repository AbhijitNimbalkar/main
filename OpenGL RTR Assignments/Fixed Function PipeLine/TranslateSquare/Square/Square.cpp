...
void resize(int width, int height)
{
	...
	if (width <= height)
	{
		glOrtho(-150.0f, 150.0f, -150.0f*GLfloat(height)/GLfloat(width), 150.0f*(height) / GLfloat(width), -150.0f, 150.0f);
	}
	else
	{
		glOrtho(-150.0f*GLfloat(width) / GLfloat(height), 150.0f*GLfloat(width) / GLfloat(height), -150.0f, 150.0f, -150.0f,150.0f);
	}
